  ...
  <div style="display: flex; flex-direction: column; height: 100vh">
    ...
    <div style="background: #efe9e2; flex: 1; overflow-y: auto">
      <div class="container mb-5">
        <div class="container mb-5">
          <h4 class="my-4" style="font-weight: 600">Add Item to cart</h4>
          <div class="row">
            <div class="col-md-4" style="cursor: pointer">
              <img :src="details.url" width="300px" height="300px" style="border-radius: 15px" />
            </div>
            <div class="col-md-4" style="cursor: pointer">
              <h5 class="my-4" style="font-weight: 600">Name: {{details.name}}</h5>
              <h5 class="my-4" style="font-weight: 600">Price: {{details.price}}</h5>
              <h5 class="my-4" style="font-weight: 600">Description: {{details.desc}}</h5>
              <h5 class="my-4" style="font-weight: 600">Rating: {{details.rate}} *</h5>
              <div>
